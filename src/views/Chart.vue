<template>
  <div class="chart">
    <div class="chart-list">
      ...
      <router-link
        to="/SongList?id=LZPhK2EyYzN15dU-PT&title=綜合新歌即時榜"
        class="chart-list-btn"
      >
        <a href>完整榜單</a>
      </router-link>
    </div>
    ...
    <hr />
    <Card :charts="newCharts" />

    <h2 class="chart-title">單曲日榜</h2>
    <hr />
    <Card :charts="dailyCharts" />

    <h2 class="chart-title">曲風週榜</h2>
    <hr />
    <Card :charts="weeklyCharts" />
  </div>
</template>
